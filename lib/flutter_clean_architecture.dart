...
import 'package:flutter_clean_architecture/src/clean_architecture_observer.dart';
...
export 'package:flutter_clean_architecture/src/clean_architecture_observer.dart';

class FlutterCleanArchitecture {
  /// The global observer for monitoring the lifecycle of Controllers and UseCases.
  static CleanArchitectureObserver? observer;
